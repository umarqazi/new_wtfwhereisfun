...
//    ],
    'sandbox' => [
        ...
        'secret'      => env('PAYPAL_SANDBOX_API_SECRET', 'AFcWxV21C7fd0v3bYYYRCpSSRl31AAEoub.9eo-6O6Sh2SSBMu9ZzSrr'),
        'certificate' => env('PAYPAL_SANDBOX_API_CERTIFICATE', ''),
        'app_id'      => 'APP-80W284485P519543T', // Used for testing Adaptive Payments API in sandbox mode
    ],
    'live' => [
    ...
    'notify_url'     => 'checkout/notify', // Change this accordingly for your application.
