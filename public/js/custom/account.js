 ...
 ******************************************************************************/
function organizerPaymentInfo(){
    if($('#radio_5').is(":checked")){

        $('.payment_email_info').hide();
        $('.account_payment_info').show();
    }else if($('#radio_4').is(":checked")){

        $('.account_payment_info').hide();
        $('.payment_email_info').show();
    }

}
/*****************************************************************************
 ***************************Organizer Payment Info End***********************
 ******************************************************************************/
