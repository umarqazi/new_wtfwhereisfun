$(document).ready(function() {
      ...
      function readURL() {
       ...
       $(this).addClass('active');
        ...
        Pass = Pass+'<li>';
        Pass = Pass+'<input type="hidden" name="ticket_type_name[]" value="pass"><input type="text" class="form-control" placeholder="e.g General Admission" name="ticket_name[]" required=""></li>';
    ...
    $('.addAnother_event_location1').click(function(){
        ...
        $('#event_location2').val(''); 
        $('#event_address2').val('');
        $('#currencynew2 option[value="USD"]').attr("selected", "selected");
        /*$('#event_location2').val('');
        $('#event_address2').val('');
        $('#currencynew1 option[value="USD"]').attr("selected", "selected");
    ...
    $('.addAnother_event_location2').click(function(){
        ...
        $('#event_location3').val(''); 
        $('#event_address3').val('');
        $('#currencynew3 option[value="USD"]').attr("selected", "selected");
    ...
    $('.addAnother_event_location3').click(function(){
        ...
        $('#event_location4').val(''); 
        $('#event_address4').val('');
        $('#currencynew4 option[value="USD"]').attr("selected", "selected");
    ...
    $(document).on('click','#remove_eventrow1',function() {
      ...
      $('.addAnother_event_location1').addClass('hidden');
      // Clear data for currunt text box 
      $('#event_location1').val(''); 
      $('#event_address1').val('');
      $('#currencynew1 option[value="USD"]').attr("selected", "selected");
    ...
    var PaidTicket = '<ul class="listTable_row table_row clearfix hide-paid">';
        ...
        PaidTicket = PaidTicket+'<input type="hidden" name="ticket_type_name[]" value="ticket"><input type="text" class="form-control" placeholder="e.g General Admission" name="ticket_name[]" required=""></li>';
...
/* ======== Donation Ticket ====*/
    var DonationTicket = '<ul class="listTable_row table_row clearfix hide-donation">';
        ...
        DonationTicket = DonationTicket+'<input type="hidden" name="ticket_type_name[]" value="ticket"><input type="text" class="form-control" placeholder="e.g General Admission" name="ticket_name[]" required=""></li>';
...
/* ==== Free Tickets =====*/ 
    var FreeTicket = '<ul class="listTable_row table_row clearfix hide-free">';
        ...
        FreeTicket = FreeTicket+'<input type="hidden" name="ticket_type_name[]" value="ticket"><input type="text" class="form-control" placeholder="e.g General Admission" name="ticket_name[]" required=""></li>';
  ...
  $(document).on('click','.ticket_removerow',function() {
      ...
      //var ulid = $('.listTable_row').attr('id');
      //alert($(this).closest('div').attr('id'));

      if($('#myModal #example #'+ulid+':checkbox:checked').length == 1){
          
          //$( "#myModal #example #"+ulid ).prop( "checked", false );
          //$( "#myModal #example #"+ulid ).attr('checked', false);
          //$("#myModal #example #"+ulid).prop('selected',false);
      }
  ...
  /*$(document).on('click', '#connect-pass', function(){
      var selectedID = [];
      $(':checkbox[name="connect_ticket_pass[]"]:checked').each (function () {
        selectedID.push(this.id);
      });
  });*/
    $(document).on('click','.c-p-t-e',function() {   
        $("#c-p-t-e").val("Y");     
        $("#s-t-s").val("N");
        $(".c-p-t-e").css("border-color", "#86c543");
        $(".c-p-t").css("border-color", "#333");
        $(".s-t-s").css("border-color", "#333");
    });
    $(document).on('click','.c-p-t',function() {
        $('#myModal').modal('show');
        $(".c-p-t").css("border-color", "#86c543");
        $(".c-p-t-e").css("border-color", "#333");        
        $(".s-t-s").css("border-color", "#333");
    });   
   $(document).on('click','.s-t-s',function() { 
        $("#s-t-s").val("Y");     
        $("#c-p-t-e").val("N");  
        $(".s-t-s").css("border-color", "#86c543");
        $(".c-p-t").css("border-color", "#333");
        $(".c-p-t-e").css("border-color", "#333");
    });
