...
Route::group(['middleware' => ['web']], function () {
    ...
    Route::get('all-categories', 'CategoryController@index')->name('all-categories');
    Route::post('category-filter', 'MainController@searchEventsByCategory')->name('category-filter');
