                                                        ...
                                                        <tr>
                                                            <td class="imgResponsive" align="center" valign="middle" style="padding:0;">
                                                                <a href="{{url('/')}}" style="text-decoration:none;border:0">
                                                                    <img src="{{asset('img/email-images/subscribe.png')}}" alt="#" border="0" width="500" style="display:block;border:0;width:100%;max-width:500px">
                                                                </a>
                                                            </td>
                                                        </tr>
                                                    </table>
                                                    ...
                                                    <table class="centerFloat" border="0" align="center" cellpadding="0" cellspacing="0">
                                                        <tr>
                                                            <td class="contBtn" align="center" style="background-color:#86C543;border-radius:45px;padding:8px 20px 8px 20px;display:inline-block;">
                                                                <a href="{{url('user/verify/'.$user->verification->token)}}" target="_blank" style="font-family:'Open Sans',Arial,Helvetica,sans-serif;color:#FFFFFF;font-size:12px;line-height:20px;font-weight:700;letter-spacing:0.5px;text-align:center;text-decoration:none;">CONFIRM</a>
                                                            </td>
                                                        </tr>
                                                    </table>
                                                </td>
