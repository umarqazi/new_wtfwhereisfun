                                                    ...
                                                    <tr>
                                                        <td align="center" valign="middle">
                                                            <a href="{{url('/')}}" style="text-decoration:none;border:0">
                                                                <img src="{{asset('img/logos/stub-logo.png')}}" alt="#" border="0" width="100" style="display:block;border:0;width:170px;padding:0;padding-bottom:30px;">
                                                            </a>
                                                        </td>
                                                    </tr>
                                                    <tr>
                                                        <td class="footerText centerText" align="center" valign="middle" style="font-family:'Open Sans',Arial,Helvetica,sans-serif;color:#939393;font-size:14px;line-height:22px;font-weight:400;letter-spacing:0px;padding:0;padding-bottom:5px;">
                                                            <a href="{{url('/')}}" style="color:#939393;text-decoration:underline" target="_blank">View Web Version</a>&nbsp;|&nbsp;<a href="{{url('privacy-policy')}}" style="color:#939393;text-decoration:underline" target="_blank">Privacy Policy</a>
                                                        </td>
                                                    </tr>
                                                    <tr>
