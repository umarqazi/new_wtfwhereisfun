                                            ...
                                            <div class="row">
                                                <form method="get" onsubmit="eventLocationForm(event, this)">
                                                    ...
                                                    <div class="col-sm-6">
                                                        ...
                                                        <div class="form-group">
                                                            <div class="applybutton_right">
                                                                <button type="button" class="btn btn-default profile-btn rounded-border">Edit</button>
                                                            </div>
                                                        </div>
                                                    </div>
                                                    <div class="col-sm-6">
                                                ...
                                                <div class="col-sm-6">
                                                    ...
                                                    <div class="form-group">
                                                        <div class="form-button">
                                                            ...
                                                            <button type="button" style="display:none;" class="btn btn-default btn-edit rounded-border">Edit</button>
                                                        </div>
                                                    </div>
                                                    <input type="hidden" value="{{$eventId}}" name="event_id">
