                                            ...
                                            <form method="post" onsubmit="eventTicketForm(event, this)">
                                                <div class="ticket-content">
                                                    ...
                                                    <ul class="listTable_row table_row  clearfix">
                                                        ...
                                                        <li>
                                                            <ol class="action_list">
                                                                <li>
                                                                    <a class="setting-click" onclick="addNewTicketPass(event,this,{{$ticket->id}})" title="Connect Pass"><i class="fa fa-plus"></i></a>
                                                                </li>
                                                                <li>
                                                    ...
                                                    <div class="form-group">
                                                        ...
                                                        <textarea class="form-control" placeholder="Additional ticket info" name="description" disabled="">{{$ticket->description}}</textarea>
                                                    ...
                                                    <div class="row release_ticket_row form-group">
                                                        <div class="col-sm-6">
                                                            ...
                                                            <div class="per_order_minmax">
                                                                <div class="ordermin">
                                                                    <input type="number" class="form-control" placeholder="Min" name="min_order" value="{{$ticket->min_order}}" disabled="disabled">
                                                                </div>
                                                                <div class="ordermax">
                                                                    <input type="number" class="form-control" placeholder="Max" name="max_order" value="{{$ticket->max_order}}" disabled="disabled">
                                                                </div>
                                                            </div>
                                                    ...
                                                    <div class="row ticket-passes-wrapper">
                                                                        ...
                                                                        <form onsubmit="updateTicketPass(event,this)" method="post">
                                                                            <div class="per_order_minmax">
                                                                                <div>
                                                                                    ...
                                                                                    <input type="text" class="form-control" placeholder="Pass Name" name="pass_name" value="{{$pass->name}}" disabled="disabled">
                                                                                </div>
                                                                                <div>
                                                                                    <button type="submit" class="btn btn-default btn-save" style="display:none;">Save</button>
                                                                                    <button type="button" class="btn btn-default btn-edit" onclick="editEventTicketPassForm(this)">Edit</button>
                                                    ...
                                                    <div class="form-group">
                                                        <div class="applybutton_right">
                                                            <button type="button" class="btn-edit btn "
                                                                    onclick="editEventTicketForm(this)"><i class="fa fa-pencil"></i></button>
