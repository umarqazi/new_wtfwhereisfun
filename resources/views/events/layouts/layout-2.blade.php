...
@section('content')<section id="main">
                                ...
                                <ul>
                                    ...
                                    <li class="action__share" data-tooltip="Share">
                                        ...
                                        <div class="wiloke-sharing-post-social action__share-list">
                                            <a class="share-facebook facebook fb-share-button" href="" target="_blank" title="Share on Facebook"> <i class="fa fa-facebook"></i> Facebook </a>
                                            ...
                                            <a class="share-link copy_link" href="#" title="Copy link"> <i class="fa fa-link"></i> Copy Link </a>
                                        </div>
                                    </li>
                        ...
                        <div id="wiloke_about-3" class="widget widget_about widget_author widget_text"> <div class="widget_author__header">
                                <a href="https://listgo.wiloke.com/author/admin/">
                                    <div class="widget_author__avatar">
                                        ...
                                        @endif
                                        <img width="128" height="128" src="{{$organizerImage}}" class="attachment-128x128 size-128x128" sizes="(max-width: 128px) 100vw, 128px"> </div>
