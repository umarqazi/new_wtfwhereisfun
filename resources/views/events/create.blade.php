...
<div id="maincontent" class="main_content">
    ...
    <div class="formpage_wrapper">
        <div class="container">
            <div class="col-md-12 col-lg-12 col-xl-12 ">
                <a href="http://eventm.xceltec.com/account-setting" class=" pull-right btn btn-raised btn-default waves-effect back-button1">Back</a>
            </div>
                ...
                <div class="form_bg_box">
                    ...
                    <div class="form-group">
                        <div class="applybutton_right">
                            <input type="submit" id="save-temp" name="temp-save" class="btn-save" value="Next" style="background: #848484;border: none;">
                        </div>
                    </div>
