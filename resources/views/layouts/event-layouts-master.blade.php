...
<!-- Mirrored from xgio.net/listgo/css/listing-detail1.html by HTTrack Website Copier/3.x [XR&CO'2014], Wed, 26 Sep 2018 08:01:41 GMT -->
<head>
    ...
    <link rel="stylesheet" type="text/css" href="{{asset('listgo/css/lib/font-awesome.min.css')}}">
    <link rel="stylesheet" type="text/css" href="{{asset('listgo/css/lib/font-elegant.min.css')}}">
    <link rel="stylesheet" type="text/css" href="{{asset('listgo/css/lib/jquery-ui.css')}}">
    <link rel="stylesheet" type="text/css" href="{{asset('listgo/css/lib/bootstrap.min.css')}}">
