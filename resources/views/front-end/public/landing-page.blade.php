                ...
                <div class="landmarks-listings-wrap">
                    <div class="row">
                        <div class="col-md-12">
                            ...
                            <div class="{{count($todayEvents) > 4 ? 'event-slider owl-carousel owl-theme' : ''}}">
                                @if(!empty($todayEvents))
                                    @foreach($todayEvents as $location)
                                        <div class="{{count($todayEvents) > 4 ? 'item' : 'col-md-3'}}">
                                            <div class="card">
                    ...
                    <div class="row">
                        <div class="col-md-12">
                            ...
                            <div class="{{count($futureEvents) > 4 ? 'event-slider owl-carousel owl-theme' : ''}}">
                                @if(!empty($futureEvents))
                                    @foreach($futureEvents as $location)
                                        <div class="{{count($futureEvents) > 4 ? 'items': 'col-md-3'}}">
                                            <div class="card">
                                                <div class="card-inner">
                                                    <div class="card-image">
                                                        @php
